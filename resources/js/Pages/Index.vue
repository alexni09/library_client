        ...
        <div class="flex justify-center">
            <table :class="{'bg-zinc-50 border border-zinc-500': styleNumber === 1, 'bg-slate-50 border border-slate-500': styleNumber === 2}">
                ...
                <tr v-for="line in lines" :key="line.id" 
                    ...
                    <td class="px-1 w-36 whitespace-nowrap">{{ dayjs(line.datetime + '+00:00').format('YYYY/MM/DD HH:mm:ss') }}</td>
                    <td v-if="styleNumber === 1" class="px-1 w-72 border-l border-zinc-500">{{ line.command }}</td>
                    <td v-if="styleNumber === 2" class="px-1 w-72 border-l border-slate-500">{{ line.command }}</td>
